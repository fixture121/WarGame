 ...
 *          AUG 2023
 *
 *          This class represents a card game called "War" where a user competes
 *          against the computer.
 *          The game keeps track of wins for both players and determines the
 *          ultimate winner.
 *          The class extends the abstract class "Game" and implements the
 *          specific game logic.
 */
